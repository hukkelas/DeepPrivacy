...
from deep_privacy.detection.SFD_pytorch.net_s3fd import s3fd
from deep_privacy.detection.SFD_pytorch.bbox import nms, decode
from apex import amp
from deep_privacy.torch_utils import to_cuda
net = s3fd()
net.load_state_dict(torch.load('deep_privacy/detection/SFD_pytorch/data/s3fd_convert.pth'))
